...
namespace Workshop3_Team4.Models
{
    public partial class Package
    {
       
        //internal object PackageLineItems;
        private String frmdet = "{0, -10}{1, -30}{2, -30}{3, -15}";     // customer data is formatted in columns
        ...
        {
            return String.Format(frmdet, PackageId.ToString(),
                   PkgName, PkgDesc, PkgBasePrice.ToString("c"));
        }
    }
}
